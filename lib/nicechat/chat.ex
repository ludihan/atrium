defmodule Nicechat.Chat do
  @moduledoc """
  The chat context: channels and messages, persisted in Postgres and pushed to
  ...
  alias Nicechat.Repo
  alias Nicechat.Chat.{Channel, Message}

  @pubsub Nicechat.PubSub
  @recent_limit 100
