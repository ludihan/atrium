defmodule Nicechat.Chat.Channel do
  @moduledoc "A named room. Many channels share the single server address, IRC-style."
  use Ecto.Schema
  ...
  schema "channels" do
    ...
    has_many :messages, Nicechat.Chat.Message
